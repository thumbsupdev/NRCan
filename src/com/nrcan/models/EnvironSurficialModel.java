...
public class EnvironSurficialModel {
	...
	// Table column keys
		...
		private static final String ENVIRONSURFICIAL_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS " + ENVIRONSURFICIAL_TABLE_NAME +" (" +
				...
				");";
	public EnvironSurficialModel(Context context, DatabaseHandler dbHandler) {
		this.context = context;
        this.dbHandler = dbHandler;
	}
	
	public EnvironSurficialEntity readRow() {
        ...
        try {
            ...
            dbHandler.executeQuery(PreparedStatements.READ_FIRST_ROW, new String[] { ENVIRONSURFICIAL_TABLE_NAME, ENVIRONSURFICIAL_STATION_ID, String.valueOf(environsurficial.getID()) });
            database.setTransactionSuccessful();
        } finally {
            database.endTransaction();
        }

        return new EnvironSurficialEntity(dbHandler.getSplitRow(0));
    }
	/*
	...
	*/
	public long insertRow() {
        ...
        try {
            ...
            values.put(ENVIRONSURFICIAL_NRCID2, " ");
            ...
            long rowID = database.insert(ENVIRONSURFICIAL_TABLE_NAME, null, values);
            environsurficial.setID(String.valueOf(rowID));
	...
	public int updateRow() {
        ...
        try {
            ...
            rowsAffected = database.update(ENVIRONSURFICIAL_TABLE_NAME, values, CHECKth 5 ENVIRONSURFICIAL_STATION_ID + "=?",
                    new String[] { String.valueOf(environsurficial.getID()) });
    ...
    public int deleteRow() {
        ...
        try {
            rowsAffected = database.delete(ENVIRONSURFICIAL_TABLE_NAME, ENVIRONSURFICIAL_STATION_ID + "=?",
                    new String[] { String.valueOf(environsurficial.getID()) });
            database.setTransactionSuccessful();
        } finally {
            database.endTransaction();
    ...
    public void setEntity(String[] earthmatbedrock) {
        this.environsurficial = new EnvironSurficialEntity(environsurficial);
    }
