...
public class MineralBedrockModel {
	...
	public void readRow() {
		String[] tmp = new String[] { MINERALBEDROCK_TABLE_NAME, MINERALBEDROCK_NRCID3, String.valueOf(mineralbedrock.getNrcanId3()) };
	...
	public void insertRow() {
        ...
        mineralbedrock.setNrcanId3((int)rowID);
	...
	public void updateRow() {
        ...
        String whereClause = MINERALBEDROCK_NRCID3 + " = ?";
 		String[] whereArgs = new String[] {
 				String.valueOf(mineralbedrock.getNrcanId3())
 				};
